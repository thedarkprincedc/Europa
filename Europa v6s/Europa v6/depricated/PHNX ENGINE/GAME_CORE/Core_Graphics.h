...
static IDirect3DTexture9 *GETCACHEDTEXTURE(IDirect3DDevice9 *pDevice, string texturefilename,  D3DCOLOR colorKey){
	//USES_CONVERSION;
...
static ID3DXFont *GETFONTOBJECT(IDirect3DDevice9 *pDevice, char *fontname, int fontsize){
