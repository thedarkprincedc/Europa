...
public:
	...
	virtual void TranslateRel(float x, float y, float z);
	virtual void TranslateRel(float x, float y);
...
class CWorldObject : public CWorldTransform { // World Object - Object that needs
											  // to be positioned and rendered in 3d space
public:
